...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-amber-700 via-orange-600 to-amber-600 rounded-3xl p-8 shadow-xl text-white relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="absolute bottom-0 left-20 -mb-10 w-32 h-32 bg-orange-300 opacity-20 rounded-full blur-2xl pointer-events-none"></div>
        
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h1 className="text-3xl font-extrabold mb-2 tracking-tight">Welcome back, {user?.name}! 👋</h1>
            <p className="text-amber-100 text-lg max-w-2xl font-medium">
          ...
          <div className="flex gap-3">
            <Link to="/dashboard/lr" className="inline-flex items-center px-4 py-2.5 bg-white text-amber-700 font-bold rounded-xl shadow-lg hover:bg-amber-50 hover:scale-105 transition-all duration-200">
              <PlusCircle className="w-5 h-5 mr-2" />
              New LR
            </Link>
            <Link to="/dashboard/loading" className="inline-flex items-center px-4 py-2.5 bg-amber-800/50 text-white font-bold rounded-xl border border-amber-400/30 hover:bg-amber-800/80 backdrop-blur-sm hover:scale-105 transition-all duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-amber-50 to-white rounded-2xl p-6 shadow-md border border-amber-100 hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group cursor-default">
          <div className="flex items-center justify-between mb-4">
            <div className="bg-amber-100 p-3 rounded-xl text-amber-600 group-hover:bg-amber-600 group-hover:text-white transition-colors duration-300 shadow-sm">
          ...
          <p className="text-3xl font-extrabold text-gray-900 group-hover:text-amber-700 transition-colors duration-300 drop-shadow-sm">
            {isLoading ? <span className="animate-pulse bg-amber-200/50 rounded w-16 h-8 inline-block"></span> : lrs.length}
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-stone-50 to-white rounded-2xl p-6 shadow-md border border-stone-100 hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group cursor-default">
          <div className="flex items-center justify-between mb-4">
            <div className="bg-stone-100 p-3 rounded-xl text-stone-600 group-hover:bg-stone-600 group-hover:text-white transition-colors duration-300 shadow-sm">
          ...
          <p className="text-3xl font-extrabold text-gray-900 group-hover:text-stone-700 transition-colors duration-300 drop-shadow-sm">Online</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl shadow-lg border border-gray-100/80 overflow-hidden flex flex-col hover:shadow-xl transition-shadow duration-300">
          <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
            ...
            <Link to="/dashboard/invoices" className="text-sm font-bold text-amber-600 hover:text-amber-800 flex items-center group bg-amber-50 px-3 py-1.5 rounded-lg hover:bg-amber-100 transition-colors">
          ...
          <div className="flex-1 overflow-x-auto">
            {isLoading ? (
              <div className="p-12 flex flex-col items-center justify-center text-amber-400">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {recentLRs.map((lr) => (
                    <tr key={lr._id} className="border-b border-gray-50 last:border-0 hover:bg-amber-50/50 transition-colors group">
                      <td className="p-5">
                        <Link to={`/dashboard/lr/${lr._id}`} className="font-extrabold text-amber-600 hover:text-amber-800 flex items-center gap-2">
        ...
        {/* Quick Links / Helper */}
        <div className="bg-gradient-to-br from-stone-900 via-amber-950 to-stone-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl border border-amber-900/50">
          <div className="absolute top-0 right-0 -mt-16 -mr-16 w-48 h-48 bg-amber-500 opacity-20 rounded-full blur-3xl pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 -mb-16 -ml-16 w-40 h-40 bg-orange-500 opacity-20 rounded-full blur-3xl pointer-events-none"></div>
          
          <h2 className="text-2xl font-extrabold mb-6 relative z-10 tracking-tight flex items-center">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-orange-300">Quick Actions</span>
          </h2>
          
          <div className="space-y-4 relative z-10">
            <Link to="/dashboard/lr" className="block w-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-amber-400/50 transition-all duration-300 rounded-2xl p-5 group hover:-translate-y-1 hover:shadow-lg">
              <div className="flex items-center text-amber-400 group-hover:text-amber-300 mb-2 transition-colors">
            ...
            <Link to="/dashboard/loading" className="block w-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-orange-400/50 transition-all duration-300 rounded-2xl p-5 group hover:-translate-y-1 hover:shadow-lg">
              <div className="flex items-center text-orange-400 group-hover:text-orange-300 mb-2 transition-colors">
